//
//  UPDSFoodVerificationTableViewCell.swift
//  GoFourService
//
...
class UPDSFoodVerificationTableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var btnSelectDeselct:UIButton!{
        didSet{
            btnSelectDeselct.setTitle("", for: .normal)
        }
    }
