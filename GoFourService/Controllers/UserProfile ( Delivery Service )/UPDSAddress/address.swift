...
class address: UIViewController , UITextFieldDelegate , CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        print(self.dict_get_price_taxes_details_in_address as Any)
    ...
    @objc func add_address_WB() {
        ...
        push!.dict_get_full_address = custom_dict as NSDictionary?
        push!.dict_get_price_taxes_details_in_payment = dict_get_price_taxes_details_in_address
        push!.str_get_special_not_from_payment_in_payment = str_get_special_not_from_payment_in_address
        push!.str_total_amount_after_tax_in_payment = str_total_amount_after_tax_in_address
        push!.arr_mut_food_item_in_payment = arr_mut_food_item_in_address
        ...
        /*
         var get_food_menu_list:NSMutableArray! = []
         var get_address_list:NSDictionary!
         var get_all_taxes:NSDictionary!
         */
        ...
        if let person = UserDefaults.standard.value(forKey: str_save_login_user_data) as? [String:Any] {
            ...
            let params = add_address_params(action: "addaddress",
                                            ...
                                            firstName: String(cell.txtName.text!),
