...
//  GoFourService
//
//  Created by Dishant Rajput on 06/09/22.
//
...
class order_history_details: UIViewController , CustomSegmentedControlDelegate {
    ...
    @objc func validation_before_pickup() {
        ...
        let cell = self.tble_view.cellForRow(at: indexPath) as! order_history_details_table_cell
...
//        } else {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if self.str_select_segment == "payment_option" {
            ...
            let cell:order_history_details_table_cell = tableView.dequeueReusableCell(withIdentifier: "order_history_payment_details_table_cell") as! order_history_details_table_cell
            ...
            let cell:order_history_details_table_cell = tableView.dequeueReusableCell(withIdentifier: "order_history_details_table_cell") as! order_history_details_table_cell
            ...
            let cell:order_history_details_table_cell = tableView.dequeueReusableCell(withIdentifier: "order_history_delivery_details_table_cell") as! order_history_details_table_cell
