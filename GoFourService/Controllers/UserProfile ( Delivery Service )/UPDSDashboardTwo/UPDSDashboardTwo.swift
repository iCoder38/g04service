...
class UPDSDashboardTwo: UIViewController {
    ...
    let cellReuseIdentifier = "uPDSDashboardTwoTableCell"
...
//MARK:- TABLE VIEW -
extension UPDSDashboardTwo: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell:UPDSDashboardTwoTableCell = tableView.dequeueReusableCell(withIdentifier: cellReuseIdentifier) as! UPDSDashboardTwoTableCell
...
extension UPDSDashboardTwo: UITableViewDelegate {
